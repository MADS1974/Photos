...
##### O objetivo principal é demonstrar a integração com serviços web, processamento de JSON e o carregamento dinâmico de imagens da rede utilizando a biblioteca Volley.
